...
extern "C" const char* dipole_qualify_24(const char*, double, double, double, double, double, double, double, double);

extern "C" const char* dipole_qualify_72(const char*, double, double, double, double, double, double, double, double);

extern "C" const char* dipole_qualify_80(const char*, double, double, double, double, double, double, double, double);
