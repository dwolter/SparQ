...
\medskip
\centerline{\framebox{\parbox{0.85\textwidth}{%
{\bf Note:} The algebraic reasoning module is a under current development. We point out that it may currently not be as effective as desirable.
}}}
\medskip
